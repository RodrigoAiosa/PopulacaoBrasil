...
/* ========================================
   ...
   Sempre visível, com bom contraste, em
   qualquer estado (aberta/fechada).

   Testids reais do Streamlit atual (1.6x):
   - stSidebarCollapseButton  -> fecha (fica DENTRO da sidebar)
   - stExpandSidebarButton    -> abre  (fica no header, FORA da sidebar)
   Mantemos também os nomes antigos como
...
/* Botão de ABRIR (fora da sidebar, sobre fundo claro do app):
   fundo sólido + ícone escuro, bem destacado. */
[data-testid="stExpandSidebarButton"],
[data-testid="stSidebarCollapsedControl"],
[data-testid="collapsedControl"] {
    ...
    box-shadow: 0 2px 6px rgba(18,36,31,0.15) !important;
}
...
/* Botão de FECHAR (dentro da sidebar escura):
   ícone claro para contrastar com o fundo verde-escuro. */
